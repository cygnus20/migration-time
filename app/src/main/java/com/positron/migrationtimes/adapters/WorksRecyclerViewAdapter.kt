...
class WorksRecyclerViewAdapter(private val context: Context, private val works: List<Work>,
                               private val clickListener: (Work) -> Unit) :
    RecyclerView.Adapter<WorksRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.bind(works[position], clickListener)

    }

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

        fun bind(post: Work, clickListener: (Work) -> Unit) {
