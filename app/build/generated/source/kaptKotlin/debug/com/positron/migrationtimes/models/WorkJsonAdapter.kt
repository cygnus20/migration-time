...
class WorkJsonAdapter(moshi: Moshi) : JsonAdapter<Work>() {
    ...
    override fun toString(): String = "GeneratedJsonAdapter(Work)"

    override fun fromJson(reader: JsonReader): Work {
        var id: Int? = null
    ...
    override fun toJson(writer: JsonWriter, value: Work?) {
        if (value == null) {
