...
class PredecessorVersionJsonAdapter(moshi: Moshi) : JsonAdapter<PredecessorVersion>() {
    ...
    override fun toString(): String = "GeneratedJsonAdapter(PredecessorVersion)"

    override fun fromJson(reader: JsonReader): PredecessorVersion {
        var id: Int? = null
        ...
        reader.endObject()
        var result = PredecessorVersion(
                id = id ?: throw JsonDataException("Required property 'id' missing at ${reader.path}"),
                href = href)
        return result
    }

    override fun toJson(writer: JsonWriter, value: PredecessorVersion?) {
        if (value == null) {
