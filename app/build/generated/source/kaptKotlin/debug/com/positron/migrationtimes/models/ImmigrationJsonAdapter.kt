...
class ImmigrationJsonAdapter(moshi: Moshi) : JsonAdapter<Immigration>() {
    ...
    override fun toString(): String = "GeneratedJsonAdapter(Immigration)"

    override fun fromJson(reader: JsonReader): Immigration {
        var id: Int? = null
    ...
    override fun toJson(writer: JsonWriter, value: Immigration?) {
        if (value == null) {
