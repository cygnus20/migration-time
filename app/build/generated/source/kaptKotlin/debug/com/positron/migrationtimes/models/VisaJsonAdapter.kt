...
class VisaJsonAdapter(moshi: Moshi) : JsonAdapter<Visa>() {
    ...
    override fun toString(): String = "GeneratedJsonAdapter(Visa)"

    override fun fromJson(reader: JsonReader): Visa {
        var id: Int? = null
    ...
    override fun toJson(writer: JsonWriter, value: Visa?) {
        if (value == null) {
