...
public final class Immigration implements android.os.Parcelable {
    ...
    public Immigration(@com.squareup.moshi.Json(name = "id")
    ...
    public final com.positron.migrationtimes.models.Immigration copy(@com.squareup.moshi.Json(name = "id")
    int id, @org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "date")
    java.lang.String date, @org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "date_gmt")
