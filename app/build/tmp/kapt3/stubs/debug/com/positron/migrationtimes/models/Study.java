...
public final class Study implements android.os.Parcelable {
    ...
    public Study(@com.squareup.moshi.Json(name = "id")
    ...
    public final com.positron.migrationtimes.models.Study copy(@com.squareup.moshi.Json(name = "id")
    int id, @org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "date")
    java.lang.String date, @org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "date_gmt")
