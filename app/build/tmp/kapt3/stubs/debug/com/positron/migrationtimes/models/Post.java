...
public final class Post implements android.os.Parcelable {
    ...
    public Post(@com.squareup.moshi.Json(name = "id")
    ...
    public final com.positron.migrationtimes.models.Post copy(@com.squareup.moshi.Json(name = "id")
    int id, @org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "date")
    java.lang.String date, @org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "date_gmt")
